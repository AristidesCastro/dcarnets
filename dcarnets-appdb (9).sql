...
-- Tiempo de generación: 06-05-2025 a las 22:07:28
...
CREATE TABLE IF NOT EXISTS `assignments` (
  ...
  `dependencia` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `cardsassets`
--

DROP TABLE IF EXISTS `cardsassets`;
CREATE TABLE IF NOT EXISTS `cardsassets` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `institution_id` bigint UNSIGNED NOT NULL,
  `path_archivo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cardsassets_institution_id_foreign` (`institution_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `cardsassets`
--

INSERT INTO `cardsassets` (`id`, `institution_id`, `path_archivo`, `created_at`, `updated_at`) VALUES
(1, 1, 'card-assets/1-asset-1746565938-Tayde_Nero_AI_Image_Upscaler_Photo_Face.jpeg', '2025-05-07 01:12:18', '2025-05-07 01:12:18'),
(2, 1, 'card-assets/1-asset-1746576891-WhatsApp Image 2025-05-06 at 9.54.02 AM.jpeg', '2025-05-07 04:14:51', '2025-05-07 04:14:51'),
(3, 2, 'card-assets/1-asset-1746577170-Fondo1.png', '2025-05-07 04:19:30', '2025-05-07 04:19:30'),
(4, 1, 'card-assets/1-asset-1746577920-Fondo1.png', '2025-05-07 04:32:00', '2025-05-07 04:32:00'),
(5, 1, 'card-assets/1-asset-1746579114-Fondo2.png', '2025-05-07 04:51:54', '2025-05-07 04:51:54');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cardsdesigns`
--

DROP TABLE IF EXISTS `cardsdesigns`;
CREATE TABLE IF NOT EXISTS `cardsdesigns` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `orientacion` enum('Horizontal','Vertical') COLLATE utf8mb4_unicode_ci NOT NULL,
  `caras` enum('01 Cara','02 Caras') COLLATE utf8mb4_unicode_ci NOT NULL,
  `group_id` bigint UNSIGNED NOT NULL,
  `institution_id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cardsdesigns_group_id_foreign` (`group_id`),
  KEY `cardsdesigns_institution_id_foreign` (`institution_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `cardsdesigns`
--

INSERT INTO `cardsdesigns` (`id`, `nombre`, `orientacion`, `caras`, `group_id`, `institution_id`, `created_at`, `updated_at`) VALUES
(1, 'Carnet 01', 'Horizontal', '01 Cara', 1, 1, '2025-04-10 05:33:42', '2025-04-10 05:33:42');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cardselements`
--

DROP TABLE IF EXISTS `cardselements`;
CREATE TABLE IF NOT EXISTS `cardselements` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `content` text COLLATE utf8mb4_unicode_ci,
  `posicion_X` decimal(5,2) NOT NULL DEFAULT '10.00',
  `posicion_Y` decimal(5,2) NOT NULL DEFAULT '10.00',
  `tamano_W` decimal(5,2) NOT NULL DEFAULT '30.00',
  `tamano_H` decimal(5,2) NOT NULL DEFAULT '10.00',
  `z_index` int NOT NULL DEFAULT '0',
  `cara` tinyint NOT NULL DEFAULT '1',
  `visible` tinyint(1) NOT NULL DEFAULT '1',
  `specific_properties` json DEFAULT NULL,
  `cardsdesign_id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cardselements_cardsdesign_id_foreign` (`cardsdesign_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `elementstypes`
--

DROP TABLE IF EXISTS `elementstypes`;
CREATE TABLE IF NOT EXISTS `elementstypes` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo` enum('Registro','Texto','Imagen') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Volcado de datos para la tabla `elementstypes`
--

INSERT INTO `elementstypes` (`id`, `nombre`, `tipo`, `created_at`, `updated_at`) VALUES
(1, 'Logo', 'Imagen', '2025-04-14 17:21:17', '2025-04-14 17:21:17'),
(2, 'Foto', 'Imagen', '2025-04-14 17:24:40', '2025-04-14 17:24:40'),
(3, 'Nombres', 'Registro', '2025-04-14 17:25:14', '2025-04-14 17:25:14'),
(4, 'Apellidos', 'Registro', '2025-04-14 17:26:32', '2025-04-14 17:26:32'),
(5, 'Cédula de Identidad', 'Registro', '2025-04-14 17:59:56', '2025-04-14 17:59:56'),
(6, 'Fecha de Nacimiento', 'Registro', '2025-04-14 18:01:13', '2025-04-14 18:01:13'),
(7, 'Fondo', 'Imagen', '2025-04-14 18:01:51', '2025-04-14 18:01:51'),
(8, 'Información', 'Texto', '2025-04-14 18:02:30', '2025-04-14 18:02:30');
...
INSERT INTO `groups` (`id`, `nombre`, `created_at`, `updated_at`) VALUES
(1, 'Grupo 01', NULL, NULL),
(2, 'Grupo 02', NULL, NULL),
(3, 'Grupo 03', NULL, NULL);
...
(17, '2025_04_01_205112_create_groups_table', 7),
(18, '2025_04_02_124908_create_peopletypes_table', 8),
(19, '2025_04_08_200823_create_cardsdesigns_table', 8),
(20, '2025_04_11_140106_create_elementstypes_table', 9),
(25, '2025_04_12_130901_create_cardselements_table', 10),
(26, '2025_04_15_150108_create_cardsassets_table', 11);
...
CREATE TABLE IF NOT EXISTS `people` (
  ...
  `cedula` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `peopletypes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `peopletypes_groups_id_foreign` (`group_id`),
...
INSERT INTO `peopletypes` (`id`, `nombre`, `group_id`, `institution_id`, `created_at`, `updated_at`) VALUES
(1, 'Docente', 1, 1, '2025-04-03 23:09:32', '2025-04-03 23:09:32'),
(2, 'Administrativo', 1, 1, '2025-04-03 23:10:06', '2025-04-03 23:10:06'),
(3, 'Obrero', 1, 1, '2025-04-03 23:10:26', '2025-04-03 23:10:26'),
(4, 'Estudiante', 2, 1, '2025-04-03 23:10:40', '2025-04-03 23:10:40'),
(5, 'Docente', 1, 2, '2025-04-08 23:05:58', '2025-04-08 23:05:58'),
(6, 'Administrativo', 3, 2, '2025-04-08 23:06:53', '2025-04-10 05:25:53'),
(7, 'Estudiante', 2, 2, '2025-04-08 23:07:31', '2025-04-08 23:07:31');
...
CREATE TABLE IF NOT EXISTS `periods` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `periodo` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
('UWrhvWNchAL5F5WWzUzeTmP38vGtG5IxX0wdw5dW', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36', '', 1746583552);
...
--
-- Filtros para la tabla `cardsassets`
--
ALTER TABLE `cardsassets`
  ADD CONSTRAINT `cardsassets_institution_id_foreign` FOREIGN KEY (`institution_id`) REFERENCES `institutions` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `cardsdesigns`
--
ALTER TABLE `cardsdesigns`
  ADD CONSTRAINT `cardsdesigns_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  ADD CONSTRAINT `cardsdesigns_institution_id_foreign` FOREIGN KEY (`institution_id`) REFERENCES `institutions` (`id`);

--
-- Filtros para la tabla `cardselements`
--
ALTER TABLE `cardselements`
  ADD CONSTRAINT `cardselements_cardsdesign_id_foreign` FOREIGN KEY (`cardsdesign_id`) REFERENCES `cardsdesigns` (`id`);
...
ALTER TABLE `peopletypes`
  ADD CONSTRAINT `peopletypes_groups_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
